 ...
 *
 * @param          view        UIView形态的页面
 *
 * @param          pProperties   UIView的埋点属性
 *
 */
...
+(void) ctrlClickedWithNoPagePrefix:(NSString *)controlName onPage:(NSObject *)pageName args:(nullable NSDictionary *)dict;

+(void) ctrlClicked:(NSString *)controlName onPage:(NSObject *) pageName args:(nullable NSDictionary *) dict;

+(void) ctrlClicked:(NSString *)controlName args:(nullable NSDictionary *) dict;
...
+ (void)commitEvent:(int)eventId
               ...
               arg3:(nullable NSString *)arg3 args:(nullable NSDictionary *) dict;


+ (void)commitEvent:(nonnull NSObject *)page
            eventID:(int)eventID
               arg1:(nullable NSString *)arg1
               arg2:(nullable NSString *)arg2
               arg3:(nullable NSString *)arg3
               args:(nullable NSDictionary *) dict;
...
+(void) h5UT:(NSDictionary *) dataDict vc:(UIView *) view                __deprecated;
