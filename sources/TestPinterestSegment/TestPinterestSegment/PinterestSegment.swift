  ...
  @objc public func addToLeft(image: UIImage?) {
    ...
    if let text = self.text {
      let textString = NSAttributedString(
        string: text,
        attributes: [
          .font: self.font ?? .systemFont(ofSize: 17),
...
struct UIViewWrapper: UIViewRepresentable {
  func makeUIView(context: Context) -> some PinterestSegment {
    let segment = PinterestSegment(frame: .zero)
    segment.backgroundColor = .red
    segment.setRichTextTitles(
      [
        .init(title: "book"),
        .init(title: "tool"),
        .init(title: "book2222222"),
//        .init(title: "book2222222"),
//        .init(title: "book2222222"),
//        .init(title: "book2222222"),
