...
public struct VariableBlurView2: UIViewRepresentable {
    ...
    public func makeUIView(context: Context) -> VariableBlurUIView2 {
      VariableBlurUIView2(maxBlurRadius: maxBlurRadius, direction: direction, startOffset: startOffset)
    }

    public func updateUIView(_ uiView: VariableBlurUIView2, context: Context) {
    }
}


/// credit https://github.com/jtrivedi/VariableBlurView
open class VariableBlurUIView2: UIVisualEffectView {
...
//        let ciGradientFilter =  CIFilter.smoothLinearGradient()
      ...
      ciGradientFilter.point0 = CGPoint(x: 0, y: 0.9 * height)
      ...
      print(ciGradientFilter.point0)
      print(ciGradientFilter.point1)
