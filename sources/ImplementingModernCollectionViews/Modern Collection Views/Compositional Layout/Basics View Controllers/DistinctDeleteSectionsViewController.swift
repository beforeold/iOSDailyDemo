//
//  DistinctDeleteSectionsViewController.swift
...
class DistinctDeleteSectionsViewController: UIViewController {
...
extension DistinctDeleteSectionsViewController {
    /// - Tag: PerSection
    func createLayout() -> UICollectionViewLayout {
        let layout = UICollectionViewCompositionalLayout { (sectionIndex: Int,
            layoutEnvironment: NSCollectionLayoutEnvironment) -> NSCollectionLayoutSection? in

            guard var sectionLayoutKind = SectionLayoutKind(rawValue: sectionIndex) else { return nil }
...
extension DistinctDeleteSectionsViewController: UICollectionViewDelegate {
...
//        let itemsPerSection = 10
//        var snapshot = NSDiffableDataSourceSnapshot<SectionLayoutKind, Int>()
//        var cases = SectionLayoutKind.allCases
//        cases.remove(at: 1)
//        cases.forEach {
//            snapshot.appendSections([$0])
//            let itemOffset = $0.rawValue * itemsPerSection
